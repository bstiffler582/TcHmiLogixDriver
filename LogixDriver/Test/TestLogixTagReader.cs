...
namespace Logix.Test
{
    public class TestLogixTagReader : ILogixTagReader
    {
        ...
        IEnumerable<TagDefinition> ILogixTagReader.ReadProgramTags(LogixTarget target, string program)
        {
            throw new NotImplementedException();
        }

        IEnumerable<TagDefinition> ILogixTagReader.ReadTagList(LogixTarget target)
        {
            throw new NotImplementedException();
        }

        TypeDefinition ILogixTagReader.ReadUdtInfo(LogixTarget target, ushort udtId)
        {
            throw new NotImplementedException();
        }
    }
